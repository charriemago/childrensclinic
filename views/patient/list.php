                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-pad table-striped table-hover table-standard">
                            ...
                            <tbody>
                                <tr>
                                    <td><a href="<?= URL?>patient/info" class="text-standard">Jan Lawrence Tolentino</a></td>      
                                    <td>City</td>      
                                    <td>
                                ...
                                <tr>
                                    <td><a href="<?= URL?>patient/info" class="text-standard">Rejie Salvador</a></td>      
                                    <td>City</td>      
                                     <td>
                                        <a href="#"><i class="ti-trash text-danger"></i></a>
                                    </td>                 
                                ...
                                <tr>
                                    <td><a href="<?= URL?>patient/info" class="text-standard">Khariza Fe Gapuz</a></td>      
                                    <td>City</td> 
                                     <td>
                                        <a href="#"><i class="ti-trash text-danger"></i></a>
                                    </td>               
                                ...
                                <tr>
                                    <td><a href="<?= URL?>patient/info" class="text-standard">Shie Ann Dao</a></td>      
                                    <td>City</td> 
                                     <td>
                                        <a href="#"><i class="ti-trash text-danger"></i></a>
                                    </td>               
                                ...
                                <tr>
                                    <td><a href="<?= URL?>patient/info" class="text-standard">Joan Rivera</a></td>      
                                    <td>City</td> 
                                     <td>
                                        <a href="#"><i class="ti-trash text-danger"></i></a>
                                    </td>               
                                ...
                                <tr>
                                    <td><a href="<?= URL?>patient/info" class="text-standard">Mary Flor Velasquez</a></td>  
                                    <td>City</td>     
                                     <td>
                                        <a href="#"><i class="ti-trash text-danger"></i></a>
                                    </td>      
